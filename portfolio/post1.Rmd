...
There are a lot of parts to Fantasy Baseball, but in this post, I'm going to go over a brief introduction to Fantasy Baseball (geared toward those with little to no experience, and a limited understanding of baseball), my draft strategy for batters, and what my draft strategy for batters would have been, with more time to prepare and a better understanding of the rules. I've also included the R code I used to explore the player data and to develop a draft strategy, in case you are interested in implementing some of this analysis on your own.
...
I ended up selecting Mookie Betts in my first round, because in addition to a high WAR, he was projected to steal more bases (high SB), and strike out less often (low SO) than others in the top 2%.
...
Similarly, I picked Buster Posey as a second rounder for his high WAR, and his low number of strikeouts relative to everyone else in his group. Andrelton Simmons was my fourth rounder for the same reason, with more stolen bases.
...
Yeah, while I'm sure it's useful to know how great Mike Trout is, I was picking sixth, so I had no chance of drafting him anyway. Nothing to see here.
...
###Next Installment
So what happened? Was the stress worth it? Did it end up being a reasonable draft strategy? I'll discuss that in the third installment of this series. The next installment is reserved for me going off on a tangent to explore positional talent. Nevermind that I drafted Buster Posey in the second round, but should I have drafted ANY catcher in the second round? Would I have been better off drafting a player from some other position? Which positions are preferable to select from in the early rounds? This will all be covered in the next installment. Stay tuned!

![](https://media.giphy.com/media/l0HlBxMf5YHnBdQmk/giphy.gif)

Drafting Batters in Fantasy Baseball, Part 2
